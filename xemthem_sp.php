...
<div class="tong">
    <div class="header">
        ...
        <div class="thongtin">
            ...
            <div class="taikhoan">
                ...
                {
                    echo "<a class='regis_log' href=Logout.php style='float: right'>
    ...
    <div class="menu-banner">
        ...
        <div class="banner">
            <div class="search-box">
                ...
                <div class="giohang" href="cart.php" >
    ...
    <div class="row">
        <?php
            $sql="select * from danhmuc_sp WHERE id_dm=$IDSP";
        ...
        ?>
                ...
                <h3 class="theloai"><?php echo $num['ten_dm']; ?></h3>
<div class="book">
    <?php
    $sql1="select * from sanpham where sanpham.id_dm=$iddm";
    ...
    while ($num1=mysqli_fetch_array($query1))
    {
     ...
     <div class="col-md-3 col-sm-6 sp">
        ...
        <div class="book1">
            <a href="sanpham.php?idsp=<?php echo $num1['id_sp']; ?>"><img src="images/<?php echo $num1['anh_sp']; ?>" width="270px" height="364px"></a>
            <div class="product-content">
                <i   class="title"><a href="sanpham.php?idsp=<?php echo $num1['id_sp']; ?>">
                        <?php echo $num1['ten_sp'];?>
                    </a></i>

                <div class="price"><?php echo number_format($num1['gia_sp'],0,',','.');?> VNĐ</div>
