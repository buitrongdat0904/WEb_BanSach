...
<div class="tong">
    ...
    <div class="row">
        ...
        $sql2="select * from sanpham 
                                    WHERE id_sp AND id_dm = $id ORDER BY id_sp DESC limit 4
                                     ";
        ...
        <div class="col-md-3 col-sm-4 sp">
            <div class="col-md-3 col-sm-6 sp">
                <div class="product-grid">
                    <div class="book1">
                        <a href="sanpham.php?idsp=<?php echo $num2['id_sp']; ?>"><img src="images/<?php echo $num2['anh_sp']; ?>" width="270px" height="364px"></a>
                        <div class="product-content">
                            <i   class="title"><a href="sanpham.php?idsp=<?php echo $num2['id_sp']; ?>">
                                    <?php echo $num2['ten_sp'];?>
                                </a></i>

                            <div class="price"><?php echo number_format($num2['gia_sp'],0,',','.');?> VNĐ</div>
...
<?php } ?>
    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
        <a href="xemthem_sp.php?ID=<?php echo $id; ?>" class="xem_tat">
            <div class="xem_all text-danger">
                Xem tất cả
            </div>
        </a>
    </div>
